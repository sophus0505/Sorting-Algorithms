...
ALGS1 = [insertion.sort, selection.sort, quick.sort, merge.sort, radix.sort]
# Put the sorting algorithms under test for part 2 here
ALGS2 = [insertion.sort, selection.sort, quick.sort, merge.sort, radix.sort]
...
def run_algs_part1(A, infilename):
    for alg in ALGS1:
        ...
        outfilename = 'results/' + infilename[7:] + '_' + algname(alg) + '.out'
...
def run_algs_part2(A, infilename):
    outfilename = 'results/' + infilename[7:] + '_results.csv'
    discarded = set()
